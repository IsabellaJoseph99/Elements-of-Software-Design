Details taken from assignment link: https://www.cs.utexas.edu/users/mitra/csFall2019/cs313/assgn/assgn5.html

Basic Geometry (Due 20 Sep 2019)
This assignment is on object oriented programming. You will be developing several classes that are fundamental in Geometry - Point, Circle, and Rectangle. In main() you will test the various functions that you have written for the classes. Do not change the names of the methods, attributes, or arguments. You may write as many helper functions as needed.
...
1.0 3.0 2.0                        # radius and center of C
5.0 -2.0 -3.0                      # radius and center of D
...
Use the Canvas system to submit your Geom.py file. We should receive your work by 11 PM on Friday, 20 Sep 2019. There will be substantial penalties if you do not adhere to the guidelines. Remember Python is case sensitive. The name of your file must match exactly what we have specified.
